...
#transform block to make cov matrix positive definite
     ...
     #  #if err==false #not positive semi-definite(or definite?)
         ...
         while possemi == false   #if not positive semidefinite matrix
               ...
               possemi=isempty(D[D.<0]) #iterate within this while loop until
    ...
    z[z.<1/beta/N].=0 #all element of z lower than 1/beta/N set to be 0
